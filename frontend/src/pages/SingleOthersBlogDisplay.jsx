        ...
        <div>
            ...
            <div className='flex flex-col mb-[4%]'>
                ...
                <div className='w-9/12 ml-[9.9%] flex justify-end mt-[1%]'>
                    <button onClick={ () => handleCommentOnTheBlog(comment, blogId)} className='border-2 border-[#5fedb4] bg-[#5fedb4] p-3 py-2 px-5 rounded-lg text-white font-semibold'>Comment</button>
                </div>
            </div>
